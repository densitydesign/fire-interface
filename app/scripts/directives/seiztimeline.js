...
/**
 * @ngdoc directive
 * @name fireInterfaceApp.directive:seiztimeline
 * @description
 * # seiztimeline
 */
        ...
        return {
            ...
            link: function postLink(scope, element, attrs) {
                ...
                function computeData() {
                    ...
                    bymonth = scope.seizByDate.group(function(d) {
                    ...
                    monthref.forEach(function(d, i) {
                        var found = _.find(bymonth, function(e) {
                            return e.key == d })
                        if (found) {
                ...
                var chartWidth = element[0].clientWidth
                var chartHeight = element[0].clientHeight - 40
                ...
                function draw() {
                    ...
                    x.domain(d3.extent(scope.monthdata, function(d) {
                        return parseTime(d.key); }));
                    y.domain([0, d3.max(scope.monthdata, function(d) {
                        return d.value; })]);
